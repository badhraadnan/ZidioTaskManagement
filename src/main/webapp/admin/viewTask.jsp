            ...
            <div class="row">
                <%
                    ...
                    try {
                        ...
                        ps = cn.prepareStatement("SELECT title, status, user.username FROM user JOIN task ON user.uid = task.uid");
                ...
                <div class="col-md-4 mb-4">
                    <div class="card task-card shadow border-0">
                        <div class="card-body">
                            <h5 class="card-title text-primary"><i class="fa-solid fa-tasks"></i> <%= title %></h5>
